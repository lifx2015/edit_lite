# lite-code-editor
![GitHub stars](https://img.shields.io/github/stars/lifx2015/lite-code-editor?style=social)
![npm](https://img.shields.io/npm/v/lifx-edit)  <!-- 如果发包 -->
![License](https://img.shields.io/github/license/lifx2015/lite-code-editor)
...
![lite-code-editor 截图](./screenshot.png)
## 功能特性
