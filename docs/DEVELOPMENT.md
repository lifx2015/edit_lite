# lite-code-editor 增强型预览开发手册

本文档介绍 lite-code-editor 增强型预览功能的使用方法和开发指南。
...
lite-code-editor 内置了**增强型预览引擎**，支持在 Markdown 中使用特殊指令来渲染交互式可视化组件。
...
lite-code-editor 支持用户开发自定义插件，放置在插件目录中，无需重新打包应用。
...
<body>
  ...
  <script>
    // ============================================
    // PluginRuntime - lite-code-editor 提供的运行时 API
    // ============================================
...
4. **测试**：重启 lite-code-editor，在 Markdown 中使用指令测试
5. **发布**：打包插件目录分享给其他用户
